...
class run_GUI(GUI.GUI):
    ...
    def checkCombo5(self, event):
        ...
        if (s == "Reservoirs (P1)"):
            vlv = 'I'
        elif (s == "Titrant Cannula (P2)"):
            vlv = 'E'
        elif (s == "Titrant Port (P3)"):
            vlv = 'O'
        else:
            logger.info(' invalid valve selection')
            vlv = 'I'
        ...
        if (s=='i'):
            ...
            cur_valve = "Titr. Cann. (P2)"
        elif(s=='o'):
            cur_valve = "Titr. Port (P3)"
        else:
            cur_valve = "error"
